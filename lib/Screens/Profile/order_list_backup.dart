...
//                               itemBuilder: (_, index) {
//                                 log(snapshot.data?.value?.data?[index].menifestId ?? "empty".toString());
//                                 return Card(
...
//               ),
//               Text(
//                 '$currencyIcon ${detail.grandTotal ?? 'Sale Price'}',
//                 style: kTextStyle.copyWith(
//                   color: kMainColor,
//                 ),
//               ),
...
//                                 description: detail.id.toString() ?? '',
